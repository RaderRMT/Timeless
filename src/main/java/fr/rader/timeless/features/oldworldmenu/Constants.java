...
public class Constants {
    ...
    //#if MC>=12102
    public static final int GRAY_COLOR = ColorHelper.getArgb(0xFF, 0xA0, 0xA0, 0xA0);
    public static final int WHITE_COLOR = ColorHelper.getArgb(0xFF, 0xFF, 0xFF, 0xFF);
    //#else
    ...
    public static final Text WORLD_DIRECTORY_NAME_LABEL = Text.translatable("timeless.selectWorld.resultFolder");
    ...
    public static final Text MORE_WORLD_OPTIONS_TEXT = Text.translatable("timeless.selectWorld.moreWorldOptions");
    ...
    //#if MC>=12111
    public static final Text AMPLIFIED_INFO_TEXT = Text.translatable("generator.minecraft.amplified.info").withColor(getTextColor());
    //#else
