...
public class RedstoneTab extends Tab {
    ...
    protected void populateTab(CreativeModeTab.ItemDisplayParameters parameters, CreativeModeTab.Output entries) {
        ...
        entries.accept(Items.EXPOSED_LIGHTNING_ROD);
        entries.accept(Items.WEATHERED_LIGHTNING_ROD);
        entries.accept(Items.OXIDIZED_LIGHTNING_ROD);
        entries.accept(Items.WAXED_LIGHTNING_ROD);
        entries.accept(Items.WAXED_EXPOSED_LIGHTNING_ROD);
        entries.accept(Items.WAXED_WEATHERED_LIGHTNING_ROD);
        entries.accept(Items.WAXED_OXIDIZED_LIGHTNING_ROD);
        ...
        entries.accept(Items.COPPER_CHEST);
        entries.accept(Items.EXPOSED_COPPER_CHEST);
        entries.accept(Items.WEATHERED_COPPER_CHEST);
        entries.accept(Items.OXIDIZED_COPPER_CHEST);
        entries.accept(Items.WAXED_COPPER_CHEST);
        entries.accept(Items.WAXED_EXPOSED_COPPER_CHEST);
        entries.accept(Items.WAXED_WEATHERED_COPPER_CHEST);
        entries.accept(Items.WAXED_OXIDIZED_COPPER_CHEST);
